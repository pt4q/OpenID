package pl.com.ptaq.views.masterdetail;
...
import com.vaadin.flow.router.RouteAlias;import pl.com.ptaq.views.main.MainView;


@Route(value = "master-detail", layout = MainView.class)

@RouteAlias(value = "", layout = MainView.class)@PageTitle("Master-Detail")
